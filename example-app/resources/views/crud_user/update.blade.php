    ...
    <main class="signup-form">
        <div class="cotainer">
            <div class="row justify-content-center">
                <div class="col-md-4">
                    <div class="card">
                    <h3 class="card-header text-center" style="background-color: #f44336; color: white;">Cập Nhật Thông Tin</h3>
                    <div class="card-body">
                        <form action="{{ route('user.PostUpdatetUser') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="text" placeholder="Ma SV" id="masv" class="form-control" name="masv"
                                    value="{{ $user->masv }}" required autofocus>
                                @if ($errors->has('name'))
                                    <span class="text-danger">{{ $errors->first('masv') }}</span>
                                @endif
                            </div>
                            <div class="form-group mb-3">
